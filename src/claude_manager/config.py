...
# Без ограничения poll_once делает os.walk по ~/.codex/sessions (десятки тысяч файлов
# от всех проектов) каждые 2 секунды, переключение тормозит, а сессии старше baseline
# попадают в poll как «никогда не виденные» и вываливают всю историю в Telegram.
# Значение 2 = сегодня + вчера. Codex-сессии старше двух дней бот не мониторит.
OPERATIONAL_SESSION_LOOKBACK_DAYS: int = 2
